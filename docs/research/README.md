...
12. [Statistical analysis plan](statistical_analysis_plan.md)
13. [Evaluation protocol](evaluation_protocol.md)
14. [Data and clinical governance](data_governance.md)
15. [Dataset feasibility audit](dataset_feasibility_audit.md)
16. [Dataset decision candidate](dataset_decision_candidate.md)
17. [Execution budget and backbone audit](execution_budget_and_backbone_audit.md)
18. [Estimator formalization and equivalence audit](estimator_formalization_audit.md)
19. [Baselines and ablations](baselines_and_ablations.md)
20. [Literature matrix](literature_matrix.md)
21. [Novelty and prior-art audit](novelty_audit.md)
22. [Submission strategy](submission_strategy.md)
23. [Gate-0 decision dossier](gate0_decision_dossier.md)
24. [Gate-0 closure audit](gate0_closure_audit.md)
25. [Decision log](decision_log.md)
